...
func pokeRound(num: float): int =
  if num - floor(num) > 0.5: toInt(ceil(num)) else: toInt(floor(num))

func attackerAbilityBasePowerMod(attacker: Pokemon, move: PokeMove, defender: Pokemon, field: Field, typeEffectiveness: float): int =
...
func defenderAbilityBasePowerMod(defender: Pokemon, move: PokeMove, attacker: Pokemon): int =
...
func attackerItemBasePowerMod(attacker: Pokemon, move: PokeMove): int =
...
func moveBasePowerMod(move: PokeMove, attacker, defender: Pokemon, field: Field): int =
...
func auraMod(attacker, defender: Pokemon, defAbilitySuppressed: bool): int =
...
func attackerAbilityAttackMod(attacker: Pokemon, move: PokeMove, field: Field): int =
...
func defenderAbilityAttackMod(defender: Pokemon, move: PokeMove): int =
...
func attackerItemAttackMod(attacker: Pokemon, move: PokeMove): int =
  if
...
func calculateAttack(attacker: Pokemon, move: PokeMove, defender: Pokemon, field: Field, defAbilitySuppressed: bool): int =
  var attack: int
...
func defenderItemDefenseMod(defender: Pokemon, hitsPhysical: bool): int =
...
func calculateDefense(defender, attacker: Pokemon, move: PokeMove, field: Field, defAbilitySuppressed: bool): int =
...
func attackerAbilityFinalMod(attacker: Pokemon, move: PokeMove, typeEffectiveness: float): int =
...
func defenderAbilityFinalMod(defender: Pokemon, typeEffectiveness: float): int =
...
func attackerItemFinalMod(attacker: Pokemon, typeEffectiveness: float): int = 
  if attacker.item == "Expert Belt" and typeEffectiveness > 1: 0x1333
  elif attacker.item == "Life Orb": 0x14CC
  else: 0x1000

func defenderItemFinalMod(defender, attacker: Pokemon, move: PokeMove): int =
...
func levelDamage(attacker: Pokemon): int =
  if attacker.ability == "Parental Bond": attacker.level * 2 else: attacker.level

func calculateConsistentDamage(move: PokeMove, attacker, defender: Pokemon): DamageSpread =
  var damage = 0
...
func getBaseDamage(level: int, basePower: int, attack: int, defense: int): int =
  toInt(floor(floor((floor((2 * level) / 5 + 2) * toFloat(basePower) * toFloat(attack)) / toFloat(defense)) / 50 + 2))

func calculateBaseDamage(attacker, defender: Pokemon, move: PokeMove, field: Field, basePower, attack, defense: int): int =
...
func getFinalDamage(baseAmount: int, i: int, effectiveness: float, isBurned: bool, stabMod: int, finalMod: int): int =
...
func getAvgDamage*(attacker: Pokemon, defender: Pokemon, move: PokeMove, field: Field): int =
